...
export const WORK_PUBLISH_FORM_GUIDANCE = {
  ...
  maxCopies:
    "Maximum numbered copies to mint. Enter 0 for unlimited editions. Each minted copy is a numbered NFT; collectors may value copies differently—for example, copy #1 versus copy #145.",
  externalUrl:
